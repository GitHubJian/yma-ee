...
EE.prototype._events = void 0;

EE.prototype._maxListeners = void 0;

EE.defaultMaxListeners = 10;

EE.prototype.setMaxListeners = function (v) {
...
EE.prototype.addListener = function (event, callback) {
    var n;
...
EE.prototype.once = function (event, callback) {
    function n() {
...
EE.prototype.removeListener = function (event, callback) {
    var n, s, i, h;
    if (!isFunction(callback)) throw TypeError('listener must be a function');
...
EE.listenerCount = function (e, event) {
